...
public class MVConfig {
	...
	*/
	...
	//TODO convert to real struct
	//TODO what is this for anyway?
	...
	public enum Configs {
		...
		SYSTEM_TABS_TOP("Tabs-oben", Boolean.TRUE.toString() : Boolean.FALSE.toString()),
		SYSTEM_TABS_ICON("Tabs-Icon", Boolean.FALSE.toString() : Boolean.TRUE.toString()),
		...
		SYSTEM_USE_REPLACETABLE("Ersetzungstabelle-verwenden", SystemInfo.isLinux() ? Boolean.TRUE.toString() : Boolean.FALSE.toString()),// wegen des Problems mit ext. Programmaufrufen und Leerzeichen
		...
		SYSTEM_PANEL_DOWNLOAD_DIVIDER("system-panel-download-divider", setDividerGUI),
		SYSTEM_PANEL_ABO_DIVIDER("system-panel-abo-divider", setDividerGUI),
		...
		// Extrafenster
		//TODO why duplicate path declarations?
		...
		// Programmpfade
		SYSTEM_PFAD_VLC("pfad-vlc", setVLC),
		SYSTEM_PFAD_FLVSTREAMER("pfad-flvstreamer", setFLV),
		SYSTEM_PFAD_FFMPEG("pfad-ffmpeg", setFF),
