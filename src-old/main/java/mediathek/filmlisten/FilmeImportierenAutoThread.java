...
class FilmeImportierenAutoThread extends Thread {
	...
	private final tList listeFilmeDiff;
	...
	public FilmeImportierenAutoThread(FilmlistenSuchen msFilmlisteSuchen, tList listeFilme, tList listeFilmeDiff, int days,
	...
	private boolean searchFullList(tList liste) {
		boolean ret = false;
