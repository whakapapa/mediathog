...
import mediathog.daten.ListeMediaDB;
import mediathog.filmlisten.FilmeLaden;
import mediathog.gui.*;
import mediathog.gui.actions.CreateProtocolFileAction;
import mediathog.gui.actions.ResetSettingsAction;
import mediathog.gui.actions.ShowBlacklistDialogAction;
import mediathog.gui.actions.ShowOnlineHelpAction;
import mediathog.gui.actions.export.FilmListExportAction;
import mediathog.gui.bandwidth.IBandwidthMonitor;
import mediathog.gui.bandwidth.MVBandwidthMonitorLWin;
import mediathog.gui.dialog.AboutDialog;
import mediathog.gui.dialog.DialogBeenden;
import mediathog.gui.dialog.DialogMediaDB;
import mediathog.gui.dialog.DialogStarteinstellungen;
import mediathog.gui.dialogEinstellungen.DialogEinstellungen;
import mediathog.gui.filmInformation.InfoDialog;
import mediathog.gui.messages.*;
import mediathog.javafx.MemoryMonitor;
import mediathog.javafx.StartupProgressPanel;
import mediathog.javafx.StatusBarController;
import mediathog.res.GetIcon;
import mediathog.tool.*;
import mediathog.tool.threads.IndicatorThread;
import mediathog.tool.threads.UIFilmlistLoaderThread;
import mediathog.update.CheckUpdate;
import mediathog.update.ProgrammUpdateSuchen;
...
public class MediathekGui extends JFrame {
	...
	private static final String ICON_NAME = "mediatheg-l.png";
	...
	*/
	protected void shutdownComputer() {
		...
		try {
			logger.info("Shutdown: {}", setShutLinux);
			Runtime.getRuntime().exec(setShutLinux);
