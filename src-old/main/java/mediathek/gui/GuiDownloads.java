...
import mediathog.gui.dialog.DialogBeendenZeit;
import mediathog.gui.dialog.DialogEditAbo;
import mediathog.gui.dialog.DialogEditDownload;
...
import mediathog.tool.cellrenderer.CellRendererDownloads;
					...
					Listener.addListener(new Listener(new int[]{Listener.EREIGNIS_BLACKLIST_AUCH_FUER_ABOS,
						...
						*/
						...
						private void initComponents() {
							...
							btnClear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/ico/buttons/clear.png"))); // NOI18N
