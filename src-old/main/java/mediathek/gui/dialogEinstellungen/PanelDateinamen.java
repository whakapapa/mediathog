...
public class PanelDateinamen extends PanelVorlage {
	...
	private void initComponents() {
		...
		jButtonMinus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/ico/buttons/remove.png"))); // NOI18N

		jButtonPlus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/ico/buttons/add.png"))); // NOI18N

		jButtonDown.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/ico/buttons/move-down.png"))); // NOI18N

		jButtonUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/ico/buttons/move-up.png"))); // NOI18N
